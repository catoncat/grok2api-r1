  ...
  "zh-CN": {
    translation: {
      ...
      settings: {
        ...
        console: { baseURLHelp: "Grok Console 请求与账号操作使用的基础端点。", userAgentHelp: "Console 请求和未单独配置的 Console 出口使用的浏览器 User-Agent。", chatTimeoutHelp: "Grok Console 聊天请求完成前允许等待的最长时间。", streamIdleTimeout: "流式空闲超时", streamIdleTimeoutHelp: "仅文本 SSE 连续无上游数据时允许等待的最长时间；不影响媒体和非流式请求。" },
