  ...
  "zh-CN": {
    translation: {
      ...
      statusReauthRequired: "失效",
        ...
        cleanupDescription: "先预检所选状态，单次最多匹配 {{limit}} 个账号。受模型路由绑定保护的账号不会删除；确认后才会执行，且无法撤销。",
        cleanupMatched: "匹配",
        cleanupProtected: "受保护",
        cleanupEligible: "可删除",
        cleanupSkipped: "跳过",
        cleanupCompleted: "已删除 {{deleted}} 个账号",
        cleanupPreview: "预览清理",
        cleanupConfirm: "确认删除 {{count}} 个",
        cleanupStart: "开始清理",
      },
      accountQuotaReset: {
        action: "重置额度",
      ...
      settings: {
        ...
        console: { baseURLHelp: "Grok Console 请求与账号操作使用的基础端点。", userAgentHelp: "Console 请求和未单独配置的 Console 出口使用的浏览器 User-Agent。", chatTimeoutHelp: "Grok Console 聊天请求完成前允许等待的最长时间。" },
